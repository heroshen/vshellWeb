...
import com.vshell.web.service.RoleService;
import com.vshell.web.service.UserService;
...
public class UserController extends BaseController {
	...
	public String mainPage(Map<String, Object> map) {
		...
		String auth = JSONObject.toJSONString(list);
		System.out.println(auth);
		map.put("list", JSONObject.parse(auth));
