package com.vshell.web.common.aspect;
...
public class LogAspect {
	...
	// Service层切点
	@Pointcut("@annotation(com.vshell.web.common.annotation.ServiceLog)")
	public void serviceAspect() {
	}

	// Controller层切点
	@Pointcut("@annotation(com.vshell.web.common.annotation.ControllerLog)")
