...
import com.vshell.web.common.MapperKey;
import com.vshell.web.common.annotation.Authority;
import com.vshell.web.common.utils.AnnotationUtil;
import com.vshell.web.common.utils.JsonConvertUtil;
...
public class OperationService extends AbstratService<AuthOperation> {
	// 扫描包
	private static final String PERMISS_PACKAGE = "com.vshell.web.controller";
